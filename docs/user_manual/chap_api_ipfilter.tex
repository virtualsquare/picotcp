...
\item \texttt{in$\_$addr} - incoming address to be filtered
\item \texttt{in$\_$addr$\_$netmask} - incoming address-netmask to be filtered
\item \texttt{out$\_$port} - outgoing port to be filtered
\item \texttt{in$\_$port} - incoming port to be filtered
