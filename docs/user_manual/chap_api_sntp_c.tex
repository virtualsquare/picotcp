...
You can then retrieve the time with the pico$\_$sntp$\_$gettimeofday function.
...
\item \texttt{cb$\_$synced} - Callback function that is called when the synchronisation process is done. The status variable indicates whether the synchronisation was successful or not.
\end{itemize}
